<template>
  <div class="home">
        ...
        <div>
          <b-button-group size="sm">
            <b-button variant="outline-light" v-b-modal.add-deal>
              <b-icon icon="file-earmark-plus-fill" v-on:click="getContract" ></b-icon> New Deal
            </b-button>
    ...
    <b-table :items="items" :fields="fields" :filter="filter" responsive class="align-middle"  v-for="item in list" v-bind:key="item.id" >
      <template #cell(item)="row">
        <b>{{ row.item.deal_type }} </b>
      </template>
      <template #cell(deal_date)="row"><b>{{ row.item.deal_date }}</b>
      </template>
        ...
        <b-card>
          <b-row>
            ...
            <b-col sm="12" md="6" lg="2">
              <div class="menu-sec">
                <b-button variant="outline-light" size="sm" class="wd-100p mb-2">
    ...
    <b-modal id="add-deal" ref="modal" title="Deal Details" @ok="nav_update" size="xl" variant="primary">
      <b-card header="Deal Details" header-tag="header">
        <b-row>
          <b-col>
            <b-form-group id="fieldset-1" label="Deal Date" label-for="example-datepicker">
              <b-form-datepicker id="example-datepicker" v-model="temp_deal.deal_date" class="mb-2" size="sm">
              </b-form-datepicker>
            </b-form-group>
          </b-col>
          <b-col>
            <b-form-group label="Exchange Rate">
              <b-form-input v-model="temp_deal.exchange_rate" size="sm"></b-form-input>
            </b-form-group>
          </b-col>

          <b-col>
            <b-form-group label="i_o_IRH">
              <b-form-input v-model="temp_deal.i_o_IRH" size="sm"></b-form-input>
            </b-form-group>
          </b-col>

          <b-col>
            <b-form-group label="Source of funds">
              <b-form-input v-model="temp_deal.source_of_funds" size="sm"></b-form-input>
            </b-form-group>
          </b-col>
        ...
        <b-row>
          <b-col>
            <b-form-group label="USD Amount">
              <b-form-input v-model="temp_deal.amount_in_USD" size="sm"></b-form-input>
            </b-form-group>
          </b-col>
          <b-col>
            <b-form-group label="MYR Amount">
              <b-form-input v-model="temp_deal.amount_in_MYR" size="sm"></b-form-input>
            </b-form-group>
          </b-col>

          <b-col>
            <b-form-group label="Deal No">
              <b-form-input v-model="temp_deal.deal_no" size="sm"></b-form-input>
            </b-form-group>
          </b-col>

          <b-col>
            <b-form-group label="NoOf Setle">
              <b-form-input v-model="temp_deal.NoOf_Setle" size="sm"></b-form-input>
            </b-form-group>
          </b-col>
        </b-row>
      </b-card>
        ...
        <b-row>
          <b-col>
            <b-form-group label="Purchase Date">
              <b-form-datepicker v-model="temp_deal.purchase_date" class="mb-2" size="sm"></b-form-datepicker>
            </b-form-group>
          </b-col>
          <b-col>
            <b-form-group label="Service Charge" label-for="input-1">
              <b-form-input id="input-1" v-model="temp_deal.Service_Charge" size="sm"></b-form-input>
            </b-form-group>
          </b-col>
          <b-col>
            <b-form-group label="Service Tax">
              <b-form-input v-model="temp_deal.Service_Tax" size="sm"></b-form-input>
            </b-form-group>
          </b-col>
          <b-col>
            <b-form-group label="Created By">
              <b-form-input v-model="temp_deal.created_by" size="sm"></b-form-input>
            </b-form-group>
          </b-col>
        </b-row>
        ...
        <b-row>
          <b-col>
            <b-form-group label="Edited By">
              <b-form-input v-model="temp_deal.edited_by" size="sm"></b-form-input>
            </b-form-group>
          </b-col>
          ...
          <b-col>
            <b-form-group label="Bank POC">
              <b-form-input v-model="temp_deal.Bank_POC" size="sm"></b-form-input>
            </b-form-group>
          </b-col>
      ...
      <b-form-textarea id="textarea" v-model="temp_deal.comment" placeholder="Remarks" rows="3" max-rows="6">
      </b-form-textarea>
...
export default {
  ...
  data() {
    return {
      token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NTMxMTMyNTcsInN1YiI6ImFuc2hpa2FndXB0YTU4M0BnbWFpbC5jb20ifQ.8nHju6H4hYur2lW8ejF-H_4y36gTlCetNeXi-VrZ0uE",
      filter: null,
      temp_deal: {
         list: undefined
      },
