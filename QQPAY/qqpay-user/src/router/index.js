...
const routes = [
  ...
  },
  {
    ...
    component: () => import('../views/beneficiary/BeneficiarySummary.vue')
  },
  {
    path: '/transactionsummary',
    name: 'TransactionSummary',
    component: () => import('../views/transaction/TransactionSummary.vue')
  },
  {
    path: '/transaction',
    name: 'Transaction',
  ...
  },
  {
    ...
    component: () => import('../views/settings/business/BusinessDetails.vue')
  },
  {
    path: '/businessdocuments',
    name: 'BusinessDocuments',
    component: () => import('../views/settings/business/BusinessDocuments.vue')
  },
  {
    path: '/login',
    name: 'Login',
